  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="relative h-[22px] w-10 rounded-full bg-mid-gray/20 peer peer-checked:bg-background-ui peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-accent-text peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:size-[18px] after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all peer-disabled:opacity-50"></div>
      </label>
      {isUpdating && (
