      ...
      <div className="flex items-center space-x-1">
        {editingShortcutId === shortcutId ? (
          <div
            ...
            className="px-2 py-1 text-sm font-semibold border border-accent-text bg-logo-primary/30 rounded-md"
          >
            {formatCurrentKeys()}
          </div>
        ) : (
          <div
            className="px-2 py-1 text-sm font-semibold bg-mid-gray/10 border border-mid-gray/80 hover:bg-logo-primary/10 rounded-md cursor-pointer hover:border-accent-text"
