...
const PopoverWindow: React.FC = () => {
  // Si el usuario tiene esta tarjeta abierta cuando un dictado se rechaza,
  // el aviso va acá — es la ventana que está mirando. Rust elige una sola
  // ventana por aviso, así que no se duplica (ver `useRecordingErrorToast`).
